      ...
      <div class="header-outs" id="home">
         <div class="header-w3layouts">
			...
			<div class="headr-title">
			               <div class="hedder-up">
                  <a class="navbar-brand" href="index.php"><img src="images/abc.jpg.png" height="50px;;" width="55%;"></img></a>
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                           ...
                           <a class="dropdown-item" href="Batchregistration.php">Batch Registration</a>
						   <a class="dropdown-item" href="Memberregistration.php">Member Registration</a>
                        </div>
                     </li>
                     <li class="nav-item">
